                    ...
                    <div class="card-body">
                        <form method="POST" action="/movieupload" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="producer" type="text" class="form-control @error('producer') is-invalid @enderror" name="producer" value="{{ old('producer') }}" required autocomplete="producer" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="agerating" type="text" class="form-control @error('agerating') is-invalid @enderror" name="agerating" value="{{ old('agerating') }}" required autocomplete="agerating" autofocus>
